    ...
    questions: [
      {
        ...
        explanation: "您 là đại từ xưng hô tôn kính dùng cho cấp trên, thầy cô hoặc đối tác. 你 dùng cho đối tượng ngang hàng."
      },
      {
        id: "1.2",
        title: "Câu 1.2",
        ...
        options: [
          ...
          { label: "B", text: "学生", isCorrect: false },
          { label: "C", text: "同学", isCorrect: false },
          { label: "D", text: "老师", isCorrect: false }
        ],
        explanation: "大家 là đại từ tập thể chỉ toàn bộ những người có mặt trong ngữ cảnh giao tiếp."
      },
      {
        id: "1.3",
        title: "Câu 1.3",
        ...
        options: [
          ...
          { label: "C", text: "你好", isCorrect: false },
          { label: "D", text: "不客气", isCorrect: true }
        ],
        explanation: "不客气 là đáp lời lịch sự chuẩn xác khi nhận được lời cảm ơn 谢谢."
      }
    ]
  },
  {
    ...
    questions: [
      {
        ...
        explanation: "Câu chào kính ngữ trang trọng kết hợp [Danh từ/Chức danh] + 您好 → 王老师，您好！."
      },
      {
        id: "2.2",
        title: "Câu 2.2",
        ...
        explanation: "Theo quy tắc ngữ pháp phẳng [Danh từ / Đại từ chỉ người] + 们, hậu tố 们 bắt buộc đứng sau danh từ chỉ người 同学 → 同学们."
      },
      {
        id: "2.3",
        title: "Câu 2.3",
    ...
    questions: [
      {
        ...
        explanation: "Điền 您好 để đảm bảo sắc thái tôn kính đối với cấp trên 王老师."
      },
      {
        id: "3.2",
        title: "Câu 3.2",
        ...
        explanation: "Điền 大家 để tạo thành 大家好！, biểu đạt lời chào tập thể."
      },
      {
        id: "3.3",
        title: "Câu 3.3",
    ...
    questions: [
      {
        id: "4.1",
        title: "Câu 4.1",
        content: "Tình huống: Học viên A chào cấp trên: 王老师，你好！.\nYêu cầu: Phân tích lỗi sai, chỉ ra nguyên nhân gốc rễ (RCA) và đưa ra phương án sửa.",
        answerTitle: "BÁO CÁO RCA:",
        answerContent: "**Lỗi sai**: Dùng đại từ thân mật 你 thay vì kính ngữ 您 với đối tượng là cấp trên 王老师.\n**Root Cause**: Học viên bị thói quen phản xạ câu chào chung 你好, thiếu tư duy phân cấp đối tượng giao tiếp.\n**Phương án sửa**: Thay 你 bằng 您 → 王老师，您好！."
      },
      {
        id: "4.2",
        title: "Câu 4.2",
        content: "Tình huống: Học viên B bắt đầu cuộc họp team bằng phát ngôn: 们同学，你好！.\nYêu cầu: Phân tích lỗi sai RCA và đưa ra câu sửa chuẩn xác.",
        answerTitle: "BÁO CÁO RCA:",
        answerContent: "**Lỗi sai**: Đặt sai vị trí hậu tố 们 lên trước danh từ và dùng câu chào cá nhân 你好 cho tập thể.\n**Root Cause**: Nhầm lẫn quy tắc hậu tố chỉ số nhiều (nghĩ 们 đứng trước như từ \"các\" trong tiếng Việt).\n**Phương án sửa**: Chuyển 们 ra sau danh từ và dùng từ chào tập thể → 同学们好！ hoặc 大家好！."
      },
      {
        id: "4.3",
        title: "Câu 4.3",
        content: "Tình huống: Bạn là Nhân sự Xuất nhập khẩu bàn giao xong chứng từ cho nhóm đối tác 你们. Hãy xây dựng kịch bản thoại 3 bước hoàn chỉnh chuẩn 100% Closed Lexicon.",
        answerTitle: "KỊCH BẢN GIẢI QUYẾT TÌNH HUỐNG THỰC CHÍNH:",
        answerContent: "**Bước 1 (Chào hỏi & Bàn giao)**:\nNhân sự XNK: 你们好！\n\n**Bước 2 (Cảm ơn & Đáp lời)**:\nNhân sự XNK: 谢谢你们！\nĐội ngũ đối tác: 不客气！\n\n**Bước 3 (Tạm biệt)**:\nNhân sự XNK & Đối tác: 再见！"
      }
    ]
  }
];
