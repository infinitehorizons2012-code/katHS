  ...
  "hsk1-lesson2": [
    {
      ...
      questions: [
        {
          id: "1.1",
          title: "Câu 1.1 (Theo CLO-1: Hỏi và Giới thiệu Họ tên)",
          content: "Từ chữ Hán nào dưới đây đại diện cho đại từ nghi vấn mang nghĩa 'Cái gì'?",
          options: [
            { label: "A", text: "名字 (míngzi - Danh tự - Tên)", isCorrect: false },
            { label: "B", text: "什么 (shénme - Thập ma - Cái gì)", "isCorrect": true },
            { label: "C", text: "叫 (jiào - Khiếu - Gọi là / Tên là)", isCorrect: false },
            { label: "D", text: "请问 (qǐngwèn - Thỉnh vấn - Xin hỏi)", isCorrect: false }
          ],
          explanation: "什么 (shénme - Thập ma - Cái gì) là đại từ nghi vấn dùng trong câu hỏi tên 你叫什么名字？."
        },
        {
          id: "1.2",
          title: "Câu 1.2 (Theo CLO-2: Phán đoán 是/不 & Chuỗi Xin lỗi)",
          content: "Cụm từ chữ Hán 对不起 có Pinyin, Hán-Việt và Nghĩa tiếng Việt chính xác là gì?",
          options: [
            { label: "A", text: "没关系 (méi guānxi - Một quan hệ - Không sao)", isCorrect: false },
            { label: "B", text: "不客气 (bú kèqi - Bất khách khí - Không có gì)", isCorrect: false },
            { label: "C", text: "对不起 (duìbuqǐ - Đối bất khởi - Xin lỗi)", "isCorrect": true },
        ...
        {
          id: "1.3",
          title: "Câu 1.3 (Theo CLO-3: Phó từ 很/也 & Xã giao Quen biết)",
          content: "Từ chữ Hán 高兴 được phiên âm Pinyin, Hán-Việt và giải nghĩa tiếng Việt là gì?",
          options: [
            { label: "A", text: "认识 (rènshi - Nhận thức - Quen biết / Nhận biết)", isCorrect: false },
            { label: "B", text: "高兴 (gāoxìng - Cao hưng - Vui mừng / Phấn khởi)", "isCorrect": true },
            { label: "C", text: "很 (hěn - Hấn - Rất)", isCorrect: false },
            { label: "D", text: "也 (yě - Dã - Cũng)", isCorrect: false }
          ],
    ...
    },
    {
      ...
      questions: [
        {
          id: "2.1",
          title: "Câu 2.1 (Theo CLO-1: Hỏi và Giới thiệu Họ tên)",
          content: "Cấu trúc câu hỏi tên nào dưới đây biểu đạt đúng trật tự từ trong tiếng Trung?",
          options: [
            { label: "A", text: "你叫名字什么？ (Nǐ jiào míngzi shénme?)", isCorrect: false },
            { label: "B", text: "请问，你叫什么名字？ (Qǐngwèn, nǐ jiào shénme míngzi? - Thỉnh vấn, nhĩ khiếu thập ma danh tự? - Xin hỏi, bạn tên là gì?)", "isCorrect": true },
            { label: "C", text: "什么名字叫你？ (Shénme míngzi jiào nǐ?)", isCorrect: false },
            { label: "D", text: "你名字叫什么请问？ (Nǐ míngzi jiào shénme qǐngwèn?)", isCorrect: false }
          ],
          explanation: "Trật tự từ chuẩn câu hỏi tên: [Lời mời lịch sự 请问] + [Chủ ngữ 你] + [Động từ 叫] + [Đại từ nghi vấn 什么] + [Danh từ 名字]？."
        },
        {
          id: "2.2",
          title: "Câu 2.2 (Theo CLO-2: Phán đoán 是/不 & Chuỗi Xin lỗi)",
          ...
          options: [
            ...
            { label: "D", text: "你好 (nǐ hǎo - Nhĩ hảo - Xin chào)", isCorrect: false }
          ],
        ...
        {
          id: "2.3",
          title: "Câu 2.3 (Theo CLO-3: Phó từ 很/也 & Xã giao Quen biết)",
    ...
    },
    {
      ...
      questions: [
        {
          id: "3.1",
          title: "Câu 3.1 (Theo CLO-1: Hỏi và Giới thiệu Họ tên)",
          content: "Hãy chọn cặp từ thích hợp điền vào chỗ trống (1) và (2) để hoàn thành đoạn thoại làm quen:\nĐối tác A: 请问，你叫___(1)___名字？\nBạn B: ___(2)___叫李文。",
          options: [
            { label: "A", text: "(1) 什么 (shénme) / (2) 我 (wǒ)", "isCorrect": true },
            { label: "B", text: "(1) 我 (wǒ) / (2) 什么 (shénme)", isCorrect: false },
            { label: "C", text: "(1) 是 (shì) / (2) 不 (bù)", isCorrect: false },
            { label: "D", text: "(1) 您 (nín) / (2) 叫 (jiào)", isCorrect: false }
          ],
          explanation: "Chỗ trống (1) điền đại từ nghi vấn 什么 (shénme), chỗ trống (2) điền đại từ nhân xưng 我 (wǒ) → 我叫李文 (Tôi tên là Lý Văn)."
        },
        {
          id: "3.2",
          title: "Câu 3.2 (Theo CLO-2: Phán đoán 是/不 & Chuỗi Xin lỗi)",
        ...
        {
          id: "3.3",
          title: "Câu 3.3 (Theo CLO-3: Phó từ 很/也 & Xã giao Quen biết)",
          content: "Hãy chọn câu đáp lời chuẩn xác nhất của người B khi người A nói câu xã giao lần đầu gặp mặt:\nNgười A: 很高兴认识你！\nNgười B: ___！",
          options: [
            { label: "A", text: "我不高兴！ (Wǒ bù gāoxìng! - Tôi không vui!)", isCorrect: false },
            { label: "B", text: "我也很高兴认识你！ (Wǒ yě hěn gāoxìng rènshi nǐ! - Tôi cũng rất vui được quen biết bạn!)", "isCorrect": true },
            { label: "C", text: "对不起，没关系！ (Duìbuqǐ, méi guānxi! - Xin lỗi, không sao!)", isCorrect: false },
            { label: "D", text: "你叫什么名字？ (Nǐ jiào shénme míngzi? - Bạn tên là gì?)", isCorrect: false }
          ],
    ...
    },
    {
      ...
      questions: [
        {
          id: "4.1",
          title: "Câu 4.1 (Theo CLO-1: Hỏi và Giới thiệu Họ tên - Chẩn đoán Lỗi RCA)",
        ...
        {
          id: "4.2",
          title: "Câu 4.2 (Theo CLO-2: Phán đoán 是/不 & Chuỗi Xin lỗi - Chẩn đoán Lỗi RCA)",
        ...
        {
          id: "4.3",
          title: "Câu 4.3 (Theo CLO-3: Phó từ 很/也 & Xã giao Quen biết - Giải quyết Tình huống Thực chiến)",
