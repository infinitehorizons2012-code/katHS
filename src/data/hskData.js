export const singleCharDict = {
  "你": {
    ...
    radicals: [
      { hanzi: '亻', name: 'Nhân đứng', color: '#e53e3e', strokes: [0, 1] },
      { hanzi: '尔', name: 'Nhĩ', color: '#2563eb', strokes: [2, 3, 4, 5, 6] }
    ]
  },
  "好": {
    hanzi: "好",
    ...
    radicals: [
      { hanzi: '女', name: 'Nữ', color: '#e53e3e', strokes: [0, 1, 2] },
      { hanzi: '子', name: 'Tử', color: '#2563eb', strokes: [3, 4, 5] }
    ]
  },
  "王": {
    hanzi: "王",
  ...
  "老": {
    ...
    radicals: [
      { hanzi: '耂', name: 'Lão', color: '#e53e3e', strokes: [0, 1, 2, 3] },
      { hanzi: '匕', name: 'Trủy', color: '#2563eb', strokes: [4, 5] }
    ]
  },
  "师": {
    hanzi: "师",
  ...
  "家": {
    ...
    radicals: [
      ...
      { hanzi: '豕', name: 'Thỉ', color: '#2563eb', strokes: [3, 4, 5, 6, 7, 8, 9] }
    ]
  },
  "学": {
    hanzi: "学",
  ...
  "们": {
    ...
    radicals: [
      { hanzi: '亻', name: 'Nhân đứng', color: '#e53e3e', strokes: [0, 1] },
      { hanzi: '门', name: 'Môn', color: '#2563eb', strokes: [2, 3, 4] }
    ]
  },
  "您": {
    hanzi: "您",
  ...
  "dialogues": [
    {
      ...
      "lines": [
        ...
        },
        {
          ...
          "vietnamese": "Tôi tên là Trần Thiên Trung."
        }
      ]
    },
    {
      ...
      "lines": [
        {
          ...
          "hanzi": "你好，安妮！",
          "pinyin": "Nǐ hǎo, Ānní!",
          "vietnamese": "Xin chào, Annie!"
        },
        {
          "speaker": "👤 白家月",
          "hanzi": "你好，陈天中！我不是安妮，我是白家月。",
          "pinyin": "Nǐ hǎo, Chén Tiānzhōng! Wǒ bú shì Ānní, wǒ shì Bái Jiāyuè.",
          "vietnamese": "Xin chào Trần Thiên Trung! Tôi không phải là Annie, tôi là Bạch Gia Nguyệt."
        },
        {
          "speaker": "👤 陈天中",
          "hanzi": "对不起！",
    ...
    },
    {
      ...
      "lines": [
        ...
        },
        {
          ...
          "vietnamese": "Xin chào! Tôi tên là Bạch Gia Nguyệt."
        },
        {
          "speaker": "👤 李文",
          "hanzi": "很高兴认识你。",
